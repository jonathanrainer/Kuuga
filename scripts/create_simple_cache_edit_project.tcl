...
set projectName Kuuga_Simple_Cache
...
lappend rtlFilesFull [file join $thisDir .. rtl simple_cache.sv]
lappend rtlFilesFull [file join $thisDir .. rtl simple_cache_wrapper.v]
lappend rtlFilesFull [file join $thisDir .. rtl standard_cache.sv]
lappend includeFilesFull [file join $thisDir .. rtl simple_cache_config.sv]

set simOnlyFiles {}
lappend simOnlyFiles [file join $thisDir .. tb simple_cache simple_cache_tb.sv]
lappend simOnlyFiles [file join $thisDir .. wcfg simple_cache_tb_behav.wcfg]
...
set block_design_name simple_cache_test
...
set_property top simple_cache_test_wrapper [get_filesets sources_1]
