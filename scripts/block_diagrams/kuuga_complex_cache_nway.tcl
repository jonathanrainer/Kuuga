...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net enokida_nway_wrapper_0_hit_count [get_bd_pins enokida_nway_wrapper_0/hit_count] [get_bd_pins system_ila_0/probe7]
  connect_bd_net -net enokida_nway_wrapper_0_miss_count [get_bd_pins enokida_nway_wrapper_0/miss_count] [get_bd_pins system_ila_0/probe8]
  ...
  connect_bd_net -net enokida_nway_wrapper_0_req_count [get_bd_pins enokida_nway_wrapper_0/trans_count] [get_bd_pins system_ila_0/probe10]
