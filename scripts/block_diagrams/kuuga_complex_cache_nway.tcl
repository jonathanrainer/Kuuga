...
################################################################
# This is a generated script based on design: kuuga_complex_cache_nway
#
...
# source kuuga_complex_cache_nway_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# core2axi_wrapper, core2axi_wrapper, delay_module_wrapper, enokida_nway_wrapper, godai_wrapper, gouram_wrapper
...
set design_name kuuga_complex_cache_nway
...
proc create_root_design { parentCell } {
  ...
  # Create instance: enokida_nway_wrapper_0, and set properties
  set block_name enokida_nway_wrapper
  set block_cell_name enokida_nway_wrapper_0
  if { [catch {set enokida_nway_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $enokida_nway_wrapper_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
 ] $enokida_nway_wrapper_0
  ...
  connect_bd_net -net Core2AXI_0_data_rvalid_o1 [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_rvalid_o] [get_bd_pins godai_wrapper_0/data_rvalid_i] [get_bd_pins gouram_wrapper_0/data_mem_rvalid]
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins delay_module_wrapper_0/feedback_signal] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_gnt_i]
  connect_bd_net -net Core2AXI_Data_data_rdata_o [get_bd_pins Core2AXI_Data/data_rdata_o] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_rdata_i]
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins delay_module_wrapper_0/marker_signal] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_rvalid_i]
  connect_bd_net -net Godai_0_data_addr_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_addr_i] [get_bd_pins godai_wrapper_0/data_addr_o] [get_bd_pins gouram_wrapper_0/data_mem_addr]
  connect_bd_net -net Godai_0_data_req_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_req_i] [get_bd_pins godai_wrapper_0/data_req_o] [get_bd_pins gouram_wrapper_0/data_mem_req]
  ...
  connect_bd_net -net clk_100MHz_1 [get_bd_pins Core2AXI_Data/M_AXI_ACLK] [get_bd_pins Core2AXI_Instruction/M_AXI_ACLK] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins delay_module_wrapper_0/clk] [get_bd_pins enokida_nway_wrapper_0/clk] [get_bd_pins godai_wrapper_0/clk] [get_bd_pins gouram_wrapper_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net enokida_nway_wrapper_0_cache_hit_count [get_bd_pins enokida_nway_wrapper_0/cache_hit_count] [get_bd_pins system_ila_0/probe9]
  connect_bd_net -net enokida_nway_wrapper_0_cache_mem_data_addr_o [get_bd_pins Core2AXI_Data/data_addr_i] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_addr_o]
  connect_bd_net -net enokida_nway_wrapper_0_cache_mem_data_be_o [get_bd_pins Core2AXI_Data/data_be_i] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_be_o]
  connect_bd_net -net enokida_nway_wrapper_0_cache_mem_data_req_o [get_bd_pins delay_module_wrapper_0/signal_in] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_req_o]
  connect_bd_net -net enokida_nway_wrapper_0_cache_mem_data_wdata_o [get_bd_pins Core2AXI_Data/data_wdata_i] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_wdata_o]
  connect_bd_net -net enokida_nway_wrapper_0_cache_mem_data_we_o [get_bd_pins Core2AXI_Data/data_we_i] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_we_o]
  connect_bd_net -net enokida_nway_wrapper_0_cache_miss_count [get_bd_pins enokida_nway_wrapper_0/cache_miss_count] [get_bd_pins system_ila_0/probe10]
  connect_bd_net -net enokida_nway_wrapper_0_cache_trans_count [get_bd_pins enokida_nway_wrapper_0/memory_trans_count] [get_bd_pins system_ila_0/probe8]
  connect_bd_net -net enokida_nway_wrapper_0_h_l_counter [get_bd_pins enokida_nway_wrapper_0/h_l_counter] [get_bd_pins system_ila_0/probe11]
  connect_bd_net -net enokida_nway_wrapper_0_h_s_counter [get_bd_pins enokida_nway_wrapper_0/h_s_counter] [get_bd_pins system_ila_0/probe14]
  connect_bd_net -net enokida_nway_wrapper_0_hph_l_counter [get_bd_pins enokida_nway_wrapper_0/hph_l_counter] [get_bd_pins system_ila_0/probe12]
  connect_bd_net -net enokida_nway_wrapper_0_hph_s_counter [get_bd_pins enokida_nway_wrapper_0/hph_s_counter] [get_bd_pins system_ila_0/probe15]
  connect_bd_net -net enokida_nway_wrapper_0_hpm_l_counter [get_bd_pins enokida_nway_wrapper_0/hpm_l_counter] [get_bd_pins system_ila_0/probe13]
  connect_bd_net -net enokida_nway_wrapper_0_hpm_s_counter [get_bd_pins enokida_nway_wrapper_0/hpm_s_counter] [get_bd_pins system_ila_0/probe16]
  connect_bd_net -net enokida_nway_wrapper_0_m_l_counter [get_bd_pins enokida_nway_wrapper_0/m_l_counter] [get_bd_pins system_ila_0/probe17]
  connect_bd_net -net enokida_nway_wrapper_0_m_s_counter [get_bd_pins enokida_nway_wrapper_0/m_s_counter] [get_bd_pins system_ila_0/probe18]
  connect_bd_net -net enokida_nway_wrapper_0_proc_cache_data_gnt_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_gnt_o] [get_bd_pins godai_wrapper_0/data_gnt_i]
  connect_bd_net -net enokida_nway_wrapper_0_proc_cache_data_rdata_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_rdata_o] [get_bd_pins godai_wrapper_0/data_rdata_i]
  connect_bd_net -net enokida_nway_wrapper_0_pwb_l_counter [get_bd_pins enokida_nway_wrapper_0/pwb_l_counter] [get_bd_pins system_ila_0/probe21]
  connect_bd_net -net enokida_nway_wrapper_0_pwb_s_counter [get_bd_pins enokida_nway_wrapper_0/pwb_s_counter] [get_bd_pins system_ila_0/probe22]
  connect_bd_net -net enokida_nway_wrapper_0_wb_l_counter [get_bd_pins enokida_nway_wrapper_0/wb_l_counter] [get_bd_pins system_ila_0/probe19]
  connect_bd_net -net enokida_nway_wrapper_0_wb_s_counter [get_bd_pins enokida_nway_wrapper_0/wb_s_counter] [get_bd_pins system_ila_0/probe20]
  ...
  connect_bd_net -net godai_wrapper_0_data_be_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_be_i] [get_bd_pins godai_wrapper_0/data_be_o]
  connect_bd_net -net godai_wrapper_0_data_wdata_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_wdata_i] [get_bd_pins godai_wrapper_0/data_wdata_o]
  connect_bd_net -net godai_wrapper_0_data_we_o [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_we_i] [get_bd_pins godai_wrapper_0/data_we_o]
  ...
  connect_bd_net -net gouram_wrapper_0_lock [get_bd_pins enokida_nway_wrapper_0/lock] [get_bd_pins gouram_wrapper_0/lock]
  connect_bd_net -net gouram_wrapper_0_trace_capture_enable [get_bd_pins enokida_nway_wrapper_0/trace_capture_enable] [get_bd_pins gouram_wrapper_0/trace_capture_enable]
  connect_bd_net -net gouram_wrapper_0_trace_data_o [get_bd_pins enokida_nway_wrapper_0/trace_in] [get_bd_pins gouram_wrapper_0/trace_data_o] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net gouram_wrapper_0_trace_ready [get_bd_pins enokida_nway_wrapper_0/trace_ready] [get_bd_pins gouram_wrapper_0/trace_ready]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Core2AXI_Data/M_AXI_ARESETN] [get_bd_pins Core2AXI_Instruction/M_AXI_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins delay_module_wrapper_0/rst_n] [get_bd_pins enokida_nway_wrapper_0/rst_n] [get_bd_pins godai_wrapper_0/rst_n] [get_bd_pins gouram_wrapper_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
