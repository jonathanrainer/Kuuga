...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_gnt_i]
  ...
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_rvalid_i]
  ...
  connect_bd_net -net delay_module_wrapper_0_signal_out [get_bd_pins delay_module_wrapper_0/signal_out] [get_bd_pins enokida_nway_wrapper_0/proc_cache_data_req_i]
  ...
  connect_bd_net -net enokida_nway_wrapper_0_cache_mem_data_req_o [get_bd_pins Core2AXI_Data/data_req_i] [get_bd_pins enokida_nway_wrapper_0/cache_mem_data_req_o]
  ...
  connect_bd_net -net enokida_nway_wrapper_0_req_count [get_bd_pins enokida_nway_wrapper_0/req_count] [get_bd_pins system_ila_0/probe6]
