...
################################################################
# This is a generated script based on design: kuuga_no_cache
#
...
# source kuuga_no_cache_script.tcl
...
set design_name kuuga_no_cache
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_0_data_rvalid_o1 [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins delay_module_wrapper_0/marker_signal] [get_bd_pins godai_wrapper_0/data_rvalid_i] [get_bd_pins gouram_wrapper_0/data_mem_rvalid]
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins delay_module_wrapper_0/feedback_signal] [get_bd_pins godai_wrapper_0/data_gnt_i]
  ...
  connect_bd_net -net gouram_wrapper_0_mem_req_count [get_bd_pins godai_wrapper_0/mem_req_count_o] [get_bd_pins system_ila_0/probe6]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins Core2AXI_Instruction/data_wdata_i] [get_bd_pins godai_wrapper_0/irq_i] [get_bd_pins system_ila_0/probe7] [get_bd_pins system_ila_0/probe8] [get_bd_pins xlconstant_2/dout]
