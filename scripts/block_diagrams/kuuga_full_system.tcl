...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_0_data_gnt_o1 [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins godai_wrapper_0/data_gnt_i]
  ...
  connect_bd_net -net Core2AXI_0_data_rdata_o1 [get_bd_pins Core2AXI_Data/data_rdata_o] [get_bd_pins godai_wrapper_0/data_rdata_i]
  ...
  connect_bd_net -net Godai_0_data_be_o [get_bd_pins Core2AXI_Data/data_be_i] [get_bd_pins godai_wrapper_0/data_be_o]
  connect_bd_net -net Godai_0_data_req_o [get_bd_pins Core2AXI_Data/data_req_i] [get_bd_pins godai_wrapper_0/data_req_o] [get_bd_pins gouram_wrapper_0/data_mem_req]
  connect_bd_net -net Godai_0_data_wdata_o [get_bd_pins Core2AXI_Data/data_wdata_i] [get_bd_pins godai_wrapper_0/data_wdata_o]
  connect_bd_net -net Godai_0_data_we_o [get_bd_pins Core2AXI_Data/data_we_i] [get_bd_pins godai_wrapper_0/data_we_o]
  ...
  connect_bd_net -net gouram_wrapper_0_trace_data_o [get_bd_pins gouram_wrapper_0/trace_data_o]
