...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Godai_0_data_req_o [get_bd_pins enokida_wrapper_0/proc_cache_data_req_i] [get_bd_pins godai_wrapper_0/data_req_o] [get_bd_pins gouram_wrapper_0/data_mem_req]
