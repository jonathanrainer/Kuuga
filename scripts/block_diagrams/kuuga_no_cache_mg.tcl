...
################################################################
# This is a generated script based on design: kuuga_no_cache_mg
#
...
# source kuuga_no_cache_mg_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# core2axi_wrapper, core2axi_wrapper, delay_module_wrapper, godai_wrapper, gouram_wrapper, memory_gap_counter_wrapper
...
set design_name kuuga_no_cache_mg
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_0_data_rvalid_o1 [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins delay_module_wrapper_0/marker_signal] [get_bd_pins godai_wrapper_0/data_rvalid_i] [get_bd_pins gouram_wrapper_0/data_mem_rvalid] [get_bd_pins memory_gap_counter_w_0/data_mem_rvalid]
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins delay_module_wrapper_0/feedback_signal] [get_bd_pins godai_wrapper_0/data_gnt_i] [get_bd_pins system_ila_1/probe1]
  ...
  connect_bd_net -net Godai_0_data_addr_o [get_bd_pins Core2AXI_Data/data_addr_i] [get_bd_pins godai_wrapper_0/data_addr_o] [get_bd_pins gouram_wrapper_0/data_mem_addr] [get_bd_pins system_ila_1/probe2]
  connect_bd_net -net Godai_0_data_req_o [get_bd_pins delay_module_wrapper_0/signal_in] [get_bd_pins godai_wrapper_0/data_req_o] [get_bd_pins gouram_wrapper_0/data_mem_req] [get_bd_pins memory_gap_counter_w_0/data_mem_req]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Core2AXI_Data/M_AXI_ARESETN] [get_bd_pins Core2AXI_Instruction/M_AXI_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins delay_module_wrapper_0/rst_n] [get_bd_pins godai_wrapper_0/rst_n] [get_bd_pins gouram_wrapper_0/rst_n] [get_bd_pins memory_gap_counter_w_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins Core2AXI_Instruction/data_wdata_i] [get_bd_pins godai_wrapper_0/irq_i] [get_bd_pins system_ila_2/probe4] [get_bd_pins xlconstant_2/dout]
