...
################################################################
# This is a generated script based on design: kuuga_complex_cache
#
...
# source kuuga_complex_cache_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# core2axi_wrapper, core2axi_wrapper, delay_module_wrapper, enokida_wrapper, godai_wrapper, gouram_wrapper
...
set design_name kuuga_complex_cache
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_0_data_rvalid_o1 [get_bd_pins enokida_wrapper_0/proc_cache_data_rvalid_o] [get_bd_pins godai_wrapper_0/data_rvalid_i] [get_bd_pins gouram_wrapper_0/data_mem_rvalid]
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins enokida_wrapper_0/cache_mem_data_gnt_i]
  connect_bd_net -net Core2AXI_Data_data_rdata_o [get_bd_pins Core2AXI_Data/data_rdata_o] [get_bd_pins enokida_wrapper_0/cache_mem_data_rdata_i]
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins enokida_wrapper_0/cache_mem_data_rvalid_i]
  connect_bd_net -net Godai_0_data_addr_o [get_bd_pins enokida_wrapper_0/proc_cache_data_addr_i] [get_bd_pins godai_wrapper_0/data_addr_o] [get_bd_pins gouram_wrapper_0/data_mem_addr]
  ...
  connect_bd_net -net clk_100MHz_1 [get_bd_pins Core2AXI_Data/M_AXI_ACLK] [get_bd_pins Core2AXI_Instruction/M_AXI_ACLK] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins delay_module_wrapper_0/clk] [get_bd_pins enokida_wrapper_0/clk] [get_bd_pins godai_wrapper_0/clk] [get_bd_pins gouram_wrapper_0/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net delay_module_wrapper_0_signal_out [get_bd_pins delay_module_wrapper_0/signal_out] [get_bd_pins enokida_wrapper_0/proc_cache_data_req_i]
  ...
  connect_bd_net -net enokida_wrapper_0_cache_mem_data_wdata_o [get_bd_pins Core2AXI_Data/data_wdata_i] [get_bd_pins enokida_wrapper_0/cache_mem_data_wdata_o]
  connect_bd_net -net enokida_wrapper_0_cache_mem_data_we_o [get_bd_pins Core2AXI_Data/data_we_i] [get_bd_pins enokida_wrapper_0/cache_mem_data_we_o]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Core2AXI_Data/M_AXI_ARESETN] [get_bd_pins Core2AXI_Instruction/M_AXI_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins delay_module_wrapper_0/rst_n] [get_bd_pins enokida_wrapper_0/rst_n] [get_bd_pins godai_wrapper_0/rst_n] [get_bd_pins gouram_wrapper_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
