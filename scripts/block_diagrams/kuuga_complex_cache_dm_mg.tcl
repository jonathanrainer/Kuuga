...
################################################################
# This is a generated script based on design: kuuga_complex_cache_dm_mg
#
...
# source kuuga_complex_cache_dm_mg_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# core2axi_wrapper, core2axi_wrapper, delay_module_wrapper, enokida_dm_wrapper, godai_wrapper, gouram_wrapper, memory_gap_counter_wrapper
...
set design_name kuuga_complex_cache_dm_mg
...
proc create_root_design { parentCell } {
  ...
  # Create instance: enokida_dm_wrapper_0, and set properties
  set block_name enokida_dm_wrapper
  set block_cell_name enokida_dm_wrapper_0
  if { [catch {set enokida_dm_wrapper_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $enokida_dm_wrapper_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property -dict [ list \
   CONFIG.ADDR_WIDTH {32} \
 ] $enokida_dm_wrapper_0
  ...
  connect_bd_net -net Core2AXI_0_data_rvalid_o1 [get_bd_pins enokida_dm_wrapper_0/proc_cache_data_rvalid_o] [get_bd_pins godai_wrapper_0/data_rvalid_i] [get_bd_pins gouram_wrapper_0/data_mem_rvalid]
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins delay_module_wrapper_0/feedback_signal] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_gnt_i] [get_bd_pins system_ila_1/probe2]
  connect_bd_net -net Core2AXI_Data_data_rdata_o [get_bd_pins Core2AXI_Data/data_rdata_o] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_rdata_i]
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins delay_module_wrapper_0/marker_signal] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_rvalid_i] [get_bd_pins memory_gap_counter_w_0/data_mem_rvalid]
  connect_bd_net -net Godai_0_data_addr_o [get_bd_pins enokida_dm_wrapper_0/proc_cache_data_addr_i] [get_bd_pins godai_wrapper_0/data_addr_o] [get_bd_pins gouram_wrapper_0/data_mem_addr]
  connect_bd_net -net Godai_0_data_req_o [get_bd_pins enokida_dm_wrapper_0/proc_cache_data_req_i] [get_bd_pins godai_wrapper_0/data_req_o] [get_bd_pins gouram_wrapper_0/data_mem_req]
  ...
  connect_bd_net -net enokida_dm_wrapper_0_cache_mem_data_addr_o [get_bd_pins Core2AXI_Data/data_addr_i] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_addr_o] [get_bd_pins system_ila_1/probe3]
  ...
  connect_bd_net -net enokida_dm_wrapper_0_cache_mem_data_req_o [get_bd_pins delay_module_wrapper_0/signal_in] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_req_o] [get_bd_pins memory_gap_counter_w_0/data_mem_req]
  ...
  connect_bd_net -net enokida_dm_wrapper_0_memory_trans_count [get_bd_pins enokida_dm_wrapper_0/memory_trans_count] [get_bd_pins system_ila_2/probe4]
  ...
  connect_bd_net -net gouram_wrapper_0_lock [get_bd_pins enokida_dm_wrapper_0/lock] [get_bd_pins gouram_wrapper_0/lock] [get_bd_pins system_ila_0/probe1] [get_bd_pins system_ila_1/probe1]
  connect_bd_net -net gouram_wrapper_0_trace_capture_enable [get_bd_pins enokida_dm_wrapper_0/trace_capture_enable] [get_bd_pins gouram_wrapper_0/trace_capture_enable]
  connect_bd_net -net gouram_wrapper_0_trace_data_o [get_bd_pins enokida_dm_wrapper_0/trace_in] [get_bd_pins gouram_wrapper_0/trace_data_o]
  connect_bd_net -net gouram_wrapper_0_trace_ready [get_bd_pins enokida_dm_wrapper_0/trace_ready] [get_bd_pins gouram_wrapper_0/trace_ready]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Core2AXI_Data/M_AXI_ARESETN] [get_bd_pins Core2AXI_Instruction/M_AXI_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins delay_module_wrapper_0/rst_n] [get_bd_pins enokida_dm_wrapper_0/rst_n] [get_bd_pins godai_wrapper_0/rst_n] [get_bd_pins gouram_wrapper_0/rst_n] [get_bd_pins memory_gap_counter_w_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
