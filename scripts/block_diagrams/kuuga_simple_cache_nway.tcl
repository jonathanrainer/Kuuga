...
################################################################
# This is a generated script based on design: kuuga_simple_cache_nway
#
...
# source kuuga_simple_cache_nway_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# core2axi_wrapper, core2axi_wrapper, delay_module_wrapper, godai_wrapper, gouram_wrapper, sayuru_nway_wrapper
...
set design_name kuuga_simple_cache_nway
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins sayuru_nway_wrapper_0/out_data_gnt_i]
  ...
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins sayuru_nway_wrapper_0/out_data_rvalid_i]
  ...
  connect_bd_net -net sayuru_nway_wrapper_0_out_data_req_o [get_bd_pins Core2AXI_Data/data_req_i] [get_bd_pins sayuru_nway_wrapper_0/out_data_req_o]
  ...
  connect_bd_net -net sayuru_nway_wrapper_0_req_count [get_bd_pins sayuru_nway_wrapper_0/req_count] [get_bd_pins system_ila_0/probe6]
