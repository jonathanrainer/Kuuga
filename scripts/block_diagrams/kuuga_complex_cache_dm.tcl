...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins delay_module_wrapper_0/feedback_signal] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_gnt_i]
  ...
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins delay_module_wrapper_0/marker_signal] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_rvalid_i]
