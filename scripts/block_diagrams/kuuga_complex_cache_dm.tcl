...
################################################################
# This is a generated script based on design: kuuga_complex_cache_dm
#
...
# source kuuga_complex_cache_dm_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# core2axi_wrapper, core2axi_wrapper, delay_module_wrapper, enokida_dm_wrapper, godai_wrapper, gouram_wrapper
...
set design_name kuuga_complex_cache_dm
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Core2AXI_Data_data_gnt_o [get_bd_pins Core2AXI_Data/data_gnt_o] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_gnt_i]
  ...
  connect_bd_net -net Core2AXI_Data_data_rvalid_o [get_bd_pins Core2AXI_Data/data_rvalid_o] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_rvalid_i]
  ...
  connect_bd_net -net delay_module_wrapper_0_signal_out [get_bd_pins delay_module_wrapper_0/signal_out] [get_bd_pins enokida_dm_wrapper_0/proc_cache_data_req_i]
  ...
  connect_bd_net -net enokida_dm_wrapper_0_cache_mem_data_req_o [get_bd_pins Core2AXI_Data/data_req_i] [get_bd_pins enokida_dm_wrapper_0/cache_mem_data_req_o]
  ...
  connect_bd_net -net enokida_dm_wrapper_0_req_count [get_bd_pins enokida_dm_wrapper_0/req_count] [get_bd_pins system_ila_0/probe6]
  ...
  connect_bd_net -net gouram_wrapper_0_lock [get_bd_pins enokida_dm_wrapper_0/lock] [get_bd_pins gouram_wrapper_0/lock]
  ...
  connect_bd_net -net gouram_wrapper_0_trace_data_o [get_bd_pins enokida_dm_wrapper_0/trace_in] [get_bd_pins gouram_wrapper_0/trace_data_o] [get_bd_pins system_ila_0/probe0]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins Core2AXI_Data/M_AXI_ARESETN] [get_bd_pins Core2AXI_Instruction/M_AXI_ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins delay_module_wrapper_0/rst_n] [get_bd_pins enokida_dm_wrapper_0/rst_n] [get_bd_pins godai_wrapper_0/rst_n] [get_bd_pins gouram_wrapper_0/rst_n] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
